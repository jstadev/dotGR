...
Οσον αφορα την λειτουργικότητα του Polkadot, απο τα πιο σημαντικά χαρακτηριστικά του είναι ότι διαθέτει μια ανοιχτή ψηφοφορία (επίσης γνωστή ως OpenGov) για την οργάνωση αποφάσεων, τις όποιες αναβαθμίσεις του, αλλά και της πρόσβασης σε κεφάλαια από το θησαυροφυλάκιο.
